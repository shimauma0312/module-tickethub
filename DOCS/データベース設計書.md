...
backend/
  └── migrations/
      ...
      │   ├── 000002_create_labels_milestones_tables.up.sql
      │   ├── 000002_create_labels_milestones_tables.down.sql
      │   ├── 000003_create_issues_tables.up.sql
      │   ├── 000003_create_issues_tables.down.sql
      │   ├── 000004_create_discussions_tables.up.sql
      │   ├── 000004_create_discussions_tables.down.sql
      │   ├── 000005_create_comments_reactions_tables.up.sql
      │   ├── 000005_create_comments_reactions_tables.down.sql
      │   ├── 000006_create_notifications_table.up.sql
      │   ├── 000006_create_notifications_table.down.sql
      │   ├── 000007_create_user_settings_table.up.sql
      │   ├── 000007_create_user_settings_table.down.sql
      │   ├── 000008_create_fts_tables.up.sql
      │   └── 000008_create_fts_tables.down.sql
      └── postgres/
          ├── 000001_create_users_table.up.sql
          ├── 000001_create_users_table.down.sql
          └── ... (同様の構造)
